...
public class InterfazElecciones extends JFrame
{
    ...
    /**
     * Adiciona un voto a un candidato dependiendo del medio que mas influencia el voto. 
     * Registra el genero y el rango de edad del votante.
     ...
     * @param numCandidato El numero del candidato del cual se va a mostrar el porcentaje de votos
     */
    ...
    /**
     * Muestra el dialogo de estadosticas de un candidato
     * @param numCandidato Numero del candidato.
     */
    ...
    /**
     * Actualiza la visualizacion de la interfaz <br>
     * <b>post: </b> Se actualiza la visualizacion
     */
